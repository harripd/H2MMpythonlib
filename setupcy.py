...
ext = Extension("H2MM_C", sources=["H2MM_C.pyx","rho_calc.c","fwd_back_photonbyphoton_par.c","C_H2MM.c","viterbi.c"],define_macros=[("NPY_NO_DEPRECATED_APY","NPY_1_7_API_VERSION")])
long_description = """
H2MM_C
======
